...
1. Now hit Build &rarr; Make Project on the toolbar -- don't worry if errors come up, we will fix them
2. Next, hit Run &rarr; FirstActivity on the toolbar (you can also hit the play button on the top nav)
3. Play with your next app! And grab us to help you troubleshoot.

# [Lab #1 is your homework &rarr;](https://github.com/mobileproto/Lab1)
